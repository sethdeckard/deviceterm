...
//
// SessionBindTerminalParams: wire shape for the `session.bindTerminal`
...
// reach it. The GUI is the only process that can see a terminal's foreground
// pid/tty, so it is the only legitimate binder.
