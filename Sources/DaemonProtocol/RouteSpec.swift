...
/// One point on a route. Lives here rather than in its own file because
/// it has no meaning apart from the type that carries it, matching
/// `SimulatedLocationDefect` beside `SimulatedLocation`.
