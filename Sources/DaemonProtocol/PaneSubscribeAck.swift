...
//
// The device-pane surface-lease protocol's request/response shapes.
//
...
//
// Both are notifications (no `id`, no response). This ack returns the
// `subscriptionToken` the GUI correlates its side-band surface lane and
// its acks against.
