...
//
// HardwareButton+Bridge: the daemon-only mapping from the shared
// HardwareButton wire enum (DaemonProtocol) to CoreSimulatorBridge's
// private `CSBHardwareButton` C enum.
//
