...
/// validated GUI peer, which spans sessions); `.everyone` reaches every
/// subscriber. Reusing this rather than putting a routing field on the
/// wire `DaemonEvent` keeps the audience decision off the wire.
