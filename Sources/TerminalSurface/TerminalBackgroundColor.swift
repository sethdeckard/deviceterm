...
//
// TerminalBackgroundColor: the engine's reported terminal
...
// kind reaches this type. The host uses it to keep UI chrome
// (visible scrollbar appearance, future pane bezel tinting) in sync
// with the live terminal background.
//
