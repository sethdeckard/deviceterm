...
//
// GUI-side surface tracing: the consumer sink + delay resolved from the
// environment, and the context the content view hands the renderer. The
// pure pixel scan, row schema, and JSONL sink live in the shared
